...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: "https://promptmelo.com/blog", lastModified: new Date(), changeFrequency: "weekly", priority: 0.7 },
    { url: "https://promptmelo.com/blog/how-to-optimize-ai-prompts", lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
